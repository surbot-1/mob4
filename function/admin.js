function admin() {
  ...
  var aname=sender; var am=(400-(aname.length))/2; 
  var uname=sender; var um=(400-(uname.length))/2; 
  ...
  writecStr(680-16+104,144+16+600-64,480,128,"ubuntufont",[0,0,0,255],[255,255,255,255],"Sign out"); 
	...
	function check() { 
	      ...
	      } else if (x>680-16+104 && x<680-16+104+8*24 && y>144+16+600-64 && y<144+16+600-64+32) { 
