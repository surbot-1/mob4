...
function send() { 
  ...
  if (minfo==0) { 
    ...
    writecStr(x+192,h+40,480-48,128,"ubuntubold",[0,0,0,255],[128,128,240,255],getTime()); 
  } else if(minfo==1) { 
    x=16; y=328; 
    ctx.fillStyle = "rgba(255, 255, 255, 1.0)"; // blue 
    ctx.fillRect(x, y, w+32, h+32+32); 
    writecStr(x+16,y+16,480-48,128,"ubuntubold",[0,0,0,255],[255,255,255,255],str); 
    writecStr(x+192,h+40,480-48,128,"ubuntubold",[0,0,0,255],[255,255,255,255],getTime()); 
  } 
}
